---
name: 5问造技能
description: 元 SKILL — 用 5 个必问 + 3 个补充访谈,把Pangu想要的能力封装成新 SKILL.md。基于一舟 skill-creator 简化版。触发 "[5问造技能]" 或Pangu说"建一个 X 触发词包"时使用。 Use when: creating new SKILL via interview, meta-SKILL crafting, build trigger package, capability packaging.
---
...
Pangu想要新能力 = 我用 5 问访谈 + 自动产 SKILL.md → 全流程 < 10 分钟。
...
如是内置 → 告知Pangu"直接说 `{具体指令}` 即可,不需要 SKILL"
